...
func TestProviderSchema(t *testing.T) {
	...
	wantResources := []string{"cloudinary_product_environment", "cloudinary_access_key", "cloudinary_upload_preset", "cloudinary_trigger"}
	...
	wantDataSources := []string{"cloudinary_product_environment", "cloudinary_access_key", "cloudinary_upload_preset", "cloudinary_trigger"}
